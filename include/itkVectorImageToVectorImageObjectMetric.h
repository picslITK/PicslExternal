/*=========================================================================
  ...
  Module:    $RCSfile: itkVectorImageToVectorImageObjectMetric.h,v $
  Language:  C++
  Date:      $Date: $
  Version:   $Revision: $
...
=========================================================================*/
#ifndef __itkVectorImageToVectorImageObjectMetric_h
#define __itkVectorImageToVectorImageObjectMetric_h
...
namespace itk
{
/** \class VectorImageToVectorImageObjectMetric
 *
 ...
 *
 * See VectorImageToVectorImageObjectMetricTest for a clear example of what a
 ...
 *
 * \ingroup ITK-PicslExternal
 */
template<class TFixedImage,class TMovingImage,class TVirtualImage = TFixedImage>
class ITK_EXPORT VectorImageToVectorImageObjectMetric :
  public ObjectToObjectMetric
{
public:

  /** Standard class typedefs. */
  typedef VectorImageToVectorImageObjectMetric                          Self;
  typedef ObjectToObjectMetric                              Superclass;
  typedef SmartPointer<Self>                                Pointer;
  typedef SmartPointer<const Self>                          ConstPointer;

  /** Run-time type information (and related methods). */
  itkTypeMacro(VectorImageToVectorImageObjectMetric, ObjectToObjectMetric);
  ...
  typedef VectorInterpolateImageFunction< FixedImageType,
                                    CoordinateRepresentationType >
                                                      FixedInterpolatorType;
  typedef VectorInterpolateImageFunction< MovingImageType,
                                    CoordinateRepresentationType >
  ...
  typedef VectorLinearInterpolateImageFunction< FixedImageType,
                                          CoordinateRepresentationType >
                                                  FixedLinearInterpolatorType;
  typedef VectorLinearInterpolateImageFunction< MovingImageType,
                                          CoordinateRepresentationType >
  ...
  */
  ...
  typedef typename NumericTraits<FixedImagePixelType>::ValueType FixedValueType;
  typedef typename NumericTraits< FixedValueType >::RealType     FixedRealType;
  typedef VariableSizeMatrix<FixedRealType>                      FixedGradientPixelType;
  typedef CovariantVector< FixedRealType,
                           itkGetStaticConstMacro(FixedImageDimension) >
                                                                 FixedGradientVectorPixelType;
  ...
  */
  typedef typename NumericTraits< MovingImagePixelType >::ValueType MovingValueType;
  typedef typename NumericTraits< MovingValueType >::RealType
                                                    MovingRealType;

  typedef VariableSizeMatrix<MovingRealType> MovingGradientPixelType;

  typedef CovariantVector< MovingRealType,
                           itkGetStaticConstMacro(MovingImageDimension) >
                                                    MovingGradientVectorPixelType;
  ...
  */
  ...
  typedef VectorCentralDifferenceImageFunction<
                                FixedImageType,
                                CoordinateRepresentationType>
  ...
  typedef VectorResampleImageFilter< MovingImageType,
                               VirtualImageType,
                               MovingRealType >
  ...
  typedef VectorResampleImageFilter< FixedImageType,
                               VirtualImageType,
                               FixedRealType >
...
protected:
   ...
   * class only after VectorImageToVectorImageObjectMetric:: Initialize has been called, to
  ...
  void PrintSelf(std::ostream& os, Indent indent) const
    ...
    os << indent << "VectorImageToVectorImageObjectMetric: TODO..." << std::endl;
    }
...
private:
  ...
  VectorImageToVectorImageObjectMetric(const Self &);
  //purposely not implemented
...
#include "itkVectorImageToVectorImageObjectMetric.hxx"
#endif
